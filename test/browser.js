...
window.addEventListener('WebComponentsReady', function() {
  ...
  document.head.innerHTML += '<link rel="import" id="el" href="/base/src/brick-listview.html">';

  document.querySelector('#el').addEventListener('load', function() {

    // Create the custom element.
    var customElement = document.createElement('brick-listview');
...
describe("the brick-listview", function(){

  it("should be attached to the DOM", function(){
    expect(document.querySelector("brick-listview")).not.to.be.null;
  });
